...
function get_path() return 'C:\\apcad_cache\\'; end
function get_user_path() return get_path()..'user\\'..get_user()..'\\'; end
...
function get_db_path() return get_path()..'DB\\'; end
function get_db_key() return 'db'; end 
require'sys.api.dos'.md(get_db_path());
